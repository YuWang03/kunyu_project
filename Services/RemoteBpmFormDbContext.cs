...
namespace HRSystemAPI.Services
{
    /// <summary>
    /// 遠端 BPM 表單資料庫上下文
    /// 用於連接遠端 MySQL 資料庫 (54.46.24.34)
    /// </summary>
    public class RemoteBpmFormDbContext : DbContext
    {
        public RemoteBpmFormDbContext(DbContextOptions<RemoteBpmFormDbContext> options)
            : base(options)
        {
        }
